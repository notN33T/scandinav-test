                            ...
                            if(loading) return 'Loading...'
                                ...
                                return products.map(product => {
                                    ...
                                    className={'product-c' + (product.inStock ? ' in-stock' : ' out-of-stock')}>
                                        {product.inStock}
                                        <div className='product-img-c-plp'>
                                            <img src={product.gallery[0]} alt="" />
                                        </div>
                                        <div className='product-name-price-c'>
                                            <p className='product-name-plp'>
                                                {product.name} {product.brand}
                                            </p>
                                            
                                            <p>
                                                <span className='product-symbol-plp'>
                                                    {this.props.currency.symbol}
                                                </span> 
                                                <span className='product-amount-plp'>
                                                    {product.prices[product.prices.findIndex(obj=>obj.currency.label===this.props.currency.label)].amount}
                                                </span>
                                            </p>
                                        </div>
                                        <div className='to-pdp-page'>
